package com.milkwang.framework.verifier;
...
public class Verifier {
     ...
     * @return this object to facilitate fluent verification
     */
    public Verifier addMessage(String format, Object... args) {
        messages.add(String.format(format, args));
    ...
    public Verifier isPositiveNumber(Number number, String format, Object... args) {
        isTrue(TypeUtils.isPositiveNumber(number), format, args);
        return this;
    }
     ...
     * @return the verifier
     */
    public Verifier isJson(String str, String format, Object... args) {
        try {
    ...
    public Verifier isNotNegative(Number number, String format, Object... args) {
        isTrue(TypeUtils.isNotNegative(number), format, args);
        return this;
    }
    ...
    public Verifier isMobile(String mobileString, String format, Object... args) {
        isTrue(TypeUtils.isMobile(mobileString), format, args);
        return this;
    }
    ...
    public Verifier isIPV4(String ip, String format, Object... args) {
        isTrue(TypeUtils.isIPV4(ip), format, args);
        return this;
    }
    ...
    public Verifier isMail(String mailString, String format, Object... args) {
        isTrue(TypeUtils.isMail(mailString), format, args);
        return this;
    }
     ...
     * 非中文正则表达式
     */
    private static final Pattern NOT_CHINESE_NAME = Pattern
            .compile("^[a-zA-Z0-9_]*$");
     ...
     * @return
     */
    public Verifier isNotChineseName(String name, String format, Object... args) {
        isTrue(TypeUtils.isNotChinaName(name), format, args);
        return this;
    }
     ...
     * @return
     */
    public Verifier isIdCard(String idCard, String format, Object... args) {
        isTrue(StringUtils.isNotBlank(idCard) && TypeUtils.CheckIdCardFormat(idCard), format, args);
        return this;
    }
     ...
     * @return
     */
    public Verifier isBankCard(String bankCard, String format, Object... args) {
        isTrue(StringUtils.isNotBlank(bankCard) && TypeUtils.checkBankCard(bankCard), format, args);
        return this;
    }

    public Verifier isRightUrl(String url, String format) {
        isTrue(TypeUtils.checkRightUrl(url), format);
        return this;
    }
